  ...
  return (
    <main className="main-container">
      <div style={{background:"#ffffff5e",padding:"10px"}}>
        <h3 style={{ display: "inline"}}>Token Search Results </h3>
                ...
                <div key={index} className="main-cards">
                  <div className="card">
                    ...
                    <div className="card-icon-1">
                      <IoInformationCircleOutline className="card_icon" />
                    </div>
                  </div>
                  <div className="card">
                    <div className="card-inner">
                    ...
                    <div className="card-icon-2">
                      <MdOutlineToken className="card_icon" />
                    </div>
                  </div>
                  <div className="card">
                    <div className="card-inner">
                  ...
                  <div className="card">
                    ...
                    <div className="card-icon-4">
                      <PiCurrencyDollarSimpleBold className="card_icon" />
                    </div>
                  </div>
                </div>
              </>
